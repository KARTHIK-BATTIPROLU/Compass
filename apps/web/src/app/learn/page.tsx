...
export default function LearnerDashboard() {
  return (
    <main className="min-h-screen flex items-center justify-center bg-slate-950 p-4">
      ...
      <div className="liquid-glass liquid-glass-lg relative z-10 bg-slate-900/40 rounded-3xl p-8 border border-white/10 shadow-2xl max-w-md w-full text-center">
