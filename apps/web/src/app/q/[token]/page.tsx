...
export default async function PublicQuizPage({ params }: { params: { token: string } }) {
  ...
  return (
    <main className="min-h-screen bg-slate-950 flex flex-col items-center p-4 py-12">
       <div className="bg-slate-900 border border-slate-800 p-8 rounded-3xl max-w-2xl w-full text-white shadow-2xl">
